  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(rgba(249,249,250,0.9), rgba(249,249,250,0.94)), radial-gradient(60% 50% at 50% 50%, rgba(254,178,2,0.12), transparent 70%)",
        }}
      />
      ...
      <div className="relative mx-auto w-full max-w-[1200px] px-5 md:px-8">
        <div
          ...
          style={{
            ...
            borderColor: "rgba(254,178,2,0.45)",
            opacity: visivel ? 1 : 0,
